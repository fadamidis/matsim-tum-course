...
public class RunMatsimMeasure_5pct {
    ...
    public static void main(String[] args) {
        ...
        config.network().setInputFile("scenarios/munich/network/munich-bicycle-improved.xml.gz");
...
//        config.strategy().addStrategySettings(changeSingleTripMode);
        ...
        config.controler().setOutputDirectory("scenarios/munich/output/output-measure-5pct");
        config.controler().setFirstIteration(0);
        config.controler().setLastIteration(200);
        config.controler().setRunId("munich-measure-5pct");
        ...
        ConfigUtils.writeConfig(scenario.getConfig(), "scenarios/munich/config/munich-measure-5pct_config.xml");
